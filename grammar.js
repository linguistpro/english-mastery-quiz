window.questions = [
  ...
  answer: 1,
  explanation: "'He' is singular, so 'goes' is correct."
},
{
...
},
{
  ...
  options: ["Chair", "Table", "Eat", "Book"],
  answer: 2,
  explanation: "Eat is an action verb."
},
{
  ...
  options: ["Him is my friend.", "He is my friend.", "His is my friend.", "Him are my friend."],
  answer: 1,
  explanation: "'He' is the correct subject pronoun."
},
{
  question: "What is the antonym of Brave?",
  options: ["Fearful", "Strong", "Bold", "Kind"],
  answer: 0,
...
},
{
  ...
  options: ["She don't sing.", "She doesn't sing.", "She not sings.", "She didn't sings."],
  answer: 1,
...
},
{
  ...
  answer: 0,
  explanation: "'On' is used when something is above a surface."
},
{
...
},
{
  ...
  options: ["Book", "Chair", "Sleep", "Table"],
  answer: 2,
  explanation: "Sleep is an action verb."
},
  {
  question: "Choose the correct sentence.",
  options: ["They has a new car.", "They have a new car.", "They having a new car.", "They haves a new car."],
  answer: 1,
  explanation: "'They' takes 'have'."
},
{
  question: "Fill in the blank: We ___ happy today.",
  options: ["is", "are", "am", "be"],
  answer: 1,
  explanation: "'We' always takes 'are'."
},
{
  question: "What is the opposite of Rich?",
  options: ["Wealthy", "Poor", "Kind", "Tall"],
  answer: 1,
  explanation: "Poor is the opposite of Rich."
},
{
  question: "Choose the correct spelling.",
  options: ["Environment", "Enviroment", "Environmant", "Envirenment"],
  answer: 0,
  explanation: "'Environment' is the correct spelling."
},
{
  question: "Which is a conjunction?",
  options: ["Because", "Apple", "Blue", "Chair"],
  answer: 0,
  explanation: "'Because' joins two clauses."
},
{
  question: "Complete the sentence: She can ___ very well.",
  options: ["dance", "dances", "dancing", "danced"],
  answer: 0,
  explanation: "Use the base form of the verb after 'can'."
},
{
  question: "Which word is an adverb?",
  options: ["Quickly", "Quick", "Beauty", "Chair"],
  answer: 0,
  explanation: "'Quickly' describes how an action is performed."
},
{
  question: "Choose the correct article.",
  options: ["a umbrella", "an umbrella", "the umbrella", "umbrella"],
  answer: 1,
  explanation: "Use 'an' before words beginning with a vowel sound."
},
{
...
{
  question: "Choose the correct sentence.",
  options: ["He were late.", "He was late.", "He are late.", "He be late."],
  answer: 1,
